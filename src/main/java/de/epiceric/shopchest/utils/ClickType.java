...
public class ClickType {
	...
	public ClickType(EnumClickType enumClickType, ItemStack product, double buyPrice, double sellPrice,
			ShopType shopType) {
		this.enumClickType = enumClickType;
	 ...
	 *
	 * @param player
	 *            Player whose click type should be gotten
	 ...
	 * 
	 * @param player
	 *            Player to remove the click type from
	 */
	 ...
	 *
	 * @param player
	 *            Player whose click type should be set
	 * @param clickType
	 *            Click type to set
	 */
	...
	/**
	 * @return If {@link #getClickType()} returns {@link EnumClickType#CREATE},
	 *         this returns the item, the player has hold in his hands, else
	 *         <b>null</b>.
	 */
	...
	/**
	 * @return If {@link #getClickType()} returns {@link EnumClickType#CREATE},
	 *         this returns the buy price, the player has entered, else
	 *         <b>null</b>.
	 */
	...
	/**
	 * @return If {@link #getClickType()} returns {@link EnumClickType#CREATE},
	 *         this returns the sell price, the player has entered, else
	 *         <b>null</b>.
	 */
	...
	/**
	 * @return If {@link #getClickType()} returns {@link EnumClickType#CREATE},
	 *         this returns the shop type, the player has entered, else
	 *         <b>null</b>.
	 */
