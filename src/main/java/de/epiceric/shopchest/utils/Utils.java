...
public class Utils {
	 ...
	 * @param itemStack2
	 *            The second item
	 * @return {@code true} if the given items are similar or {@code false} if
	 *         not
	 */
	public static boolean isItemSimilar(ItemStack itemStack1, ItemStack itemStack2) {
		...
		if (itemMeta1 instanceof BookMeta && itemMeta2 instanceof BookMeta) {
			...
			if ((getMajorVersion() == 9 && getRevision() == 1) || getMajorVersion() == 8) {
				...
				if (generation1 == null)
					CustomBookMeta.setGeneration(itemStack1, CustomBookMeta.Generation.ORIGINAL);
				if (generation2 == null)
	 ...
	 *
	 * @param inventory
	 *            The inventory, in which the items are counted
	 * @param itemStack
	 *            The items to count
	 ...
	 *
	 * @param inventory
	 *            Inventory, where to search for free space
	 * @param itemStack
	 *            Item, of which the amount that fits in the inventory should be
	 *            returned
	...
	/**
	 * @param p
	 *            Player whose item in his main hand should be returned
	 * @return {@link ItemStack} in his main hand, or {@code null} if he doesn't
	 *         hold one
	 */
	...
	/**
	 * @param p
	 *            Player whose item in his off hand should be returned
	 * @return {@link ItemStack} in his off hand, or {@code null} if he doesn't
	 *         hold one or the server version is below 1.9
	 */
	...
	/**
	 * @param p
	 *            Player whose item in his hand should be returned
	 * @return Item in his main hand, or the item in his off if he doesn't have
	 *         one in this main hand, or {@code null} if he doesn't have one in
	 *         both hands
	 */
	 ...
	 * @param className
	 *            Name of the class
	 * @return Class in {@code net.minecraft.server.[VERSION]} package with the
	 *         specified name or {@code null} if the class was not found
	 */
	 ...
	 * @param className
	 *            Name of the class
	 * @return Class in {@code org.bukkit.craftbukkit.[VERSION]} package with
	 *         the specified name or {@code null} if the class was not found
	 */
	 ...
	 *            Packet to send
	 * @param player
	 *            Player to which the packet should be sent
	 * @return {@code true} if the packet was sent, or {@code false} if an
	...
	/**
	 * @return The current server version with revision number (e.g. v1_9_R2,
	 *         v1_10_R1)
	 */
	...
	/**
	 * @return The revision of the current server version (e.g. <i>2</i> for
	 *         v1_9_R2, <i>1</i> for v1_10_R1)
	 */
	...
	/**
	 * @return The major version of the server (e.g. <i>9</i> for 1.9.2,
	 *         <i>10</i> for 1.10)
	 */
