...
public class CustomBookMeta {
	...
	public static Generation getGeneration(ItemStack book) {
		try {
			...
			Object generationObject = nbtTagCompound.getClass().getMethod("getInt", String.class).invoke(nbtTagCompound,
					"generation");
	...
	public static void setGeneration(ItemStack book, Generation generation) {
		try {
			...
			nbtTagCompound.getClass().getMethod("setInt", String.class, int.class).invoke(nbtTagCompound, "generation",
					generation.ordinal());
